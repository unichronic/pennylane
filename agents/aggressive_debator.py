...
def create_aggressive_debator(llm):
    def aggressive_node(state) -> dict:
        ...
        prompt_neutral = compact_text(current_neutral_response, limits["single_argument"], "last neutral argument")
...
Here is the current conversation history: {prompt_history} Here are the last arguments from the conservative analyst: {prompt_conservative} Here are the last arguments from the neutral analyst: {prompt_neutral}. If there are no responses from the other viewpoints yet, present your own argument based on the available data.
...
def run_aggressive_debator(state):
    return create_aggressive_debator(get_llm("quick", "aggressive_debator"))(state)["risk_debate_state"]
